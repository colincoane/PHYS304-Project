...
%Integrator
[rVec, vVec] = leapfrogIntegrator(nBodies, r0, v0, m, t0, tEnd, dt);
...
saveas(figure(1),fullfile(savedir,'leapfrog_plot.png'));
...
%Save plot
savedir = '/Users/colincoane/Documents/College Work/Fall 2020/PHYS 304/Project/Code';
saveas(figure(2),fullfile(savedir,'leapfrog_closeup.png'));
